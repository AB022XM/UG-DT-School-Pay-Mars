...
import ug.co.absa.schoolfees.repository.SchoolRepository;
import ug.co.absa.schoolfees.service.dto.SchoolDTO;
import ug.co.absa.schoolfees.service.mapper.SchoolMapper;
...
class SchoolResourceIT {
    ...
    void createSchool() throws Exception {
        ...
        assertThat(testSchool.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
        assertThat(testSchool.getUpdatedAt()).isEqualTo(DEFAULT_UPDATED_AT);
    ...
    void putExistingSchool() throws Exception {
        ...
        assertThat(testSchool.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
        assertThat(testSchool.getUpdatedAt()).isEqualTo(UPDATED_UPDATED_AT);
