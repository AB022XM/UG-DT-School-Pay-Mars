...
import ug.co.absa.schoolfees.repository.StudentRepository;
import ug.co.absa.schoolfees.service.dto.StudentDTO;
import ug.co.absa.schoolfees.service.mapper.StudentMapper;
...
class StudentResourceIT {
    ...
    private static final String DEFAULT_STUDENT_CONTACT = "AAAAAAAAAA";
    private static final String UPDATED_STUDENT_CONTACT = "BBBBBBBBBB";

    private static final String DEFAULT_STUDENT_ADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_STUDENT_ADDRESS = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .studentContact(DEFAULT_STUDENT_CONTACT)
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student()
            ...
            .studentContact(UPDATED_STUDENT_CONTACT)
            .studentAddress(UPDATED_STUDENT_ADDRESS)
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getStudentContact()).isEqualTo(DEFAULT_STUDENT_CONTACT);
        assertThat(testStudent.getStudentAddress()).isEqualTo(DEFAULT_STUDENT_ADDRESS);
        ...
        assertThat(testStudent.getUpdatedAt()).isEqualTo(DEFAULT_UPDATED_AT);
    ...
    void getAllStudents() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.[*].studentContact").value(hasItem(DEFAULT_STUDENT_CONTACT)))
            .andExpect(jsonPath("$.[*].studentAddress").value(hasItem(DEFAULT_STUDENT_ADDRESS)))
    ...
    void getStudent() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.studentContact").value(DEFAULT_STUDENT_CONTACT))
            .andExpect(jsonPath("$.studentAddress").value(DEFAULT_STUDENT_ADDRESS))
    ...
    void putExistingStudent() throws Exception {
        ...
        assertThat(testStudent.getStudentContact()).isEqualTo(UPDATED_STUDENT_CONTACT);
        assertThat(testStudent.getStudentAddress()).isEqualTo(UPDATED_STUDENT_ADDRESS);
        ...
        assertThat(testStudent.getUpdatedAt()).isEqualTo(UPDATED_UPDATED_AT);
