...
import ug.co.absa.schoolfees.repository.ContactInfoRepository;
import ug.co.absa.schoolfees.service.dto.ContactInfoDTO;
import ug.co.absa.schoolfees.service.mapper.ContactInfoMapper;
...
class ContactInfoResourceIT {
    ...
    void createContactInfo() throws Exception {
        ...
        assertThat(testContactInfo.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
        assertThat(testContactInfo.getUpdatedAt()).isEqualTo(DEFAULT_UPDATED_AT);
    ...
    void putExistingContactInfo() throws Exception {
        ...
        assertThat(testContactInfo.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
        assertThat(testContactInfo.getUpdatedAt()).isEqualTo(UPDATED_UPDATED_AT);
    ...
    void deleteContactInfo() throws Exception {
        ...
        restContactInfoMockMvc
            .perform(delete(ENTITY_API_URL_ID, contactInfo.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
