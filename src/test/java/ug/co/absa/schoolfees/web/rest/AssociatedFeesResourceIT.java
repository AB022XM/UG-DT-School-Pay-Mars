...
import ug.co.absa.schoolfees.repository.AssociatedFeesRepository;
import ug.co.absa.schoolfees.service.dto.AssociatedFeesDTO;
import ug.co.absa.schoolfees.service.mapper.AssociatedFeesMapper;
...
class AssociatedFeesResourceIT {
    ...
    void deleteAssociatedFees() throws Exception {
        ...
        restAssociatedFeesMockMvc
            .perform(delete(ENTITY_API_URL_ID, associatedFees.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
