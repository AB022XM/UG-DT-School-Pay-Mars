...
export class StudentClassComponent implements OnInit {
  ...
  trackId = (_index: number, item: IStudentClass): number => this.studentClassService.getStudentClassIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.studentClasses = this.refineData(dataFromBody);
  }

  protected refineData(data: IStudentClass[]): IStudentClass[] {
